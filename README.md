...
| Day019 | 五段文本两版Prompt对照与摘要评测 | 2026-09-17开始、09-18完成，提示后通过；各5/5，用时未记录 |

## 目录

- `day019/`：摘要调用脚本及[五段文本评测记录](day019/评测记录.md)。运行`python -X utf8 day019/compare_summary.py`，需当前终端配置`DEEPSEEK_API_KEY`及openai、pydantic依赖。最终为S05＋B，其余输入从记录手动替换。本人提供十次输出，两版各5/5仅代表该样本集下持平；人工0分案例不计作模型失败。助手未独立请求，未做HTTP验收、打包或完整测试。Git待本人提交推送，线上未同步。
